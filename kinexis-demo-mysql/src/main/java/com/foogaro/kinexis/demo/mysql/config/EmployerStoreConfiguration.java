package com.foogaro.kinexis.demo.mysql.config;
...
import com.foogaro.kinexis.demo.mysql.repository.mysql.EmployerMysqlRepository;
import com.foogaro.kinexis.demo.mysql.repository.redis.EmployerRedisRepository;
...
public class EmployerStoreConfiguration {
    ...
    @Bean
    public EntityStore<Employer> employerMysqlStore(EmployerMysqlRepository repository, BeanFinder beanFinder) {
        return CrudRepositoryEntityStore.builder(Employer.class, repository, beanFinder)
                .name("employerMysqlStore")
