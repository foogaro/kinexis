package com.foogaro.kinexis.demo.psql.service;
...
public class EmployerService extends KinexisService<Employer> {
    ...
    private final EmployerPostgresRepository repository;

    public EmployerService(EmployerPostgresRepository repository) {
