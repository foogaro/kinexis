package com.foogaro.kinexis.demo.mongodb.service;
...
public class EmployerService extends KinexisService<Employer> {
    ...
    private final EmployerMongodbRepository repository;

    public EmployerService(EmployerMongodbRepository repository) {
