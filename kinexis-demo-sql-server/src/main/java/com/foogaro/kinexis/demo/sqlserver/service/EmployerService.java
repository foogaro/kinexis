package com.foogaro.kinexis.demo.sqlserver.service;
...
public class EmployerService extends KinexisService<Employer> {
    ...
    private final EmployerSqlServerRepository repository;

    public EmployerService(EmployerSqlServerRepository repository) {
